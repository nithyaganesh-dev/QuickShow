...
const MovieCard = ({ movie }) => {
    ...
    return (
        ...
        rounded-2xl hover:-translate-y-1 transition duration-300 w-66">
            <img onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }} className="rounded-lg h-52 w-full object-cover
            object-right-bottom cursor-pointer" src={movie.backdrop_path} alt="image" />
            ...
            <div className="flex items-center justify-between mt-4 pb-3">
                ...
                transtion rounded-full font-medium cursor-pointer">Buy Tickets</button>
